...
- No separate database server required (SQLite database file is created automatically)
...
Update this if you want the SQLite database file stored in a different location.
